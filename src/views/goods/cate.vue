<template>
    <div>
        ...
        <!-- 添加分类对话框 -->
        <el-dialog title="添加分类" :visible.sync="aadCatDialogVisible"
            ...
            <span slot="footer" class="dialog-footer">
                <el-button @click="aadCatDialogVisible = false">取 消</el-button>
    ...
    methods: {
        ...
        addCate() {
            this.$refs.addCateFormRef.validate(async value => {
                ...
                this.getCateList()
                this.aadCatDialogVisible = false
            })
        },
        //监听对话框的关闭事件, 清除表单
        addCateDialogClosed() {
